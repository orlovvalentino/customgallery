...
window.MagicZoom = (function() {
	...
	var r = function() {
		return "mgctlbxN$MZ" + "p".toUpperCase() + " mgctlbxV$" + "v5.2.10".replace("v", "") + " mgctlbxL$" + "c".toUpperCase() + ((window.mgctlbx$Pltm && y.jTypeOf(window.mgctlbx$Pltm) === "string") ? " mgctlbxP$" + window.mgctlbx$Pltm.toLowerCase() : "")
	};
